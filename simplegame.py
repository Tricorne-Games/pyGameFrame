...
# PygameFrame (for Python 3) - Simple Game
# This file is to make smaller games that can run entirely on one script.
...
class game(object):
    ...
    def __init__(self):
        """Initialize an instance of the game object with assets."""
